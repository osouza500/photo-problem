...
# A função a seguir extrai uma palavra-chave
# do nome do arquivo; neste exercício,
# as palavras-chaves estão entre subtraços.
def extrair_palavra(nome_arquivo):
    return nome_arquivo.split("_")[1]


# A função a seguir cria um diretório de acordo
# com a palavra-chave extraída do
...
# Esta função extrai a palavra-chave, cria o
# diretório de acordo com ela e move os
